...
}; // HERE THE TYPE IS 'SUCCESS' OR 'ERROR'
...
var stripe = Stripe('pk_test_51GxPPoBgNRnAnFPl2f5BPxOlSyIppK0RHe71jIrm2hBbYVHsTYeNqeJyLiHepxN6Lhrw8UgHOZL4Vqxv3ShHoRt4009fvmJKr5');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2 ) Create checkout form + charte  credit card
